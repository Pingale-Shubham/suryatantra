...
document.querySelectorAll('.product-btn').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        showNotification(`Interested in ${productName}? Contact us for more details!`, 'info');
    });
});
...
style.textContent = `
    ...
    .loaded .hero-title, .loaded .hero-subtitle, .loaded .hero-description, .loaded .cta-button {
        opacity: 1;
...
console.log(`
🚀 Welcome to Suryatantra Enterprises LLP
📧 Contact: suryatantraa@gmail.com
📞 Phone: (+91) 9730429324
