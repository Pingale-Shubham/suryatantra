...
const About = () => {
  return (
    <>
      {/* Page Hero */}
      <header className="pt-32 pb-20 bg-gradient-to-br from-indigo-50 to-slate-50">
        <div className="max-w-7xl mx-auto px-5">
          <p className="uppercase tracking-widest text-sm text-blue-600 mb-4">About Suryatantra</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
              <span className="text-4xl font-bold text-blue-600 block mb-2">2019</span>
              <span className="text-slate-600">Year Established</span>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
              <span className="text-4xl font-bold text-blue-600 block mb-2">20+</span>
              <span className="text-slate-600">Years of Experience</span>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
              <span className="text-4xl font-bold text-blue-600 block mb-2">50+</span>
              <span className="text-slate-600">Trusted Partners</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-5">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <p className="uppercase tracking-widest text-sm text-blue-600 mb-4">Who We Are</p>
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Welcome to Suryatantra</h2>
            <p className="text-lg text-slate-600">Empowering PCB manufacturers with dependable supplies and automation expertise.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              <div className="bg-slate-50 rounded-2xl p-6 text-center shadow-md">
